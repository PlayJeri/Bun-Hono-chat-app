        ...
        >
          <div className="flex items-center justify-center h-full p-8 overflow-hidden text-gray-100 ease-out bg-gradient-to-br from-indigo-800 to-purple-900">
            <div className="relative w-full h-full">
              <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${isLogin ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${isLogin ? 'opacity-0' : 'opacity-100'}`}>
                <div className="text-center">
